...
| Booking events                    | Durable booking and notification outboxes                        | Authorised business users; coarse push event; connected Google Calendar; transactional email | Customer identity/contact/notes in web-push payloads or third-party calendar-link URLs         |
