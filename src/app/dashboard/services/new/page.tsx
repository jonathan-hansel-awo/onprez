  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (data.success) {
        ...
        setErrors({ form: data.error || 'Failed to create service' })
      }
    } catch (error) {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Create a new bookable service for your business</p>
        </div>
      </div>
